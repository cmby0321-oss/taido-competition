...
SET left_player_id = tmp_hokei_woman.left_player_id,
    ...
    left_player_flag = tmp_hokei_woman.left_player_flag,
    left_retire = tmp_hokei_woman.left_retire,
    right_retire = tmp_hokei_woman.right_retire
...
SET left_player_id = tmp_zissen_woman.left_player_id,
    ...
    left_player_flag = tmp_zissen_woman.left_player_flag,
    left_retire = tmp_zissen_woman.left_retire,
    right_retire = tmp_zissen_woman.right_retire
...
SET left_player_id = tmp_hokei_man.left_player_id,
    ...
    left_player_flag = tmp_hokei_man.left_player_flag,
    left_retire = tmp_hokei_man.left_retire,
    right_retire = tmp_hokei_man.right_retire
FROM tmp_hokei_man
...
SET left_player_id = tmp_zissen_man.left_player_id,
    ...
    left_player_flag = tmp_zissen_man.left_player_flag,
    left_retire = tmp_zissen_man.left_retire,
    right_retire = tmp_zissen_man.right_retire
FROM tmp_zissen_man
...
SET left_player_id = tmp_hokei_sonen.left_player_id,
    ...
    left_player_flag = tmp_hokei_sonen.left_player_flag,
    left_retire = tmp_hokei_sonen.left_retire,
    right_retire = tmp_hokei_sonen.right_retire
